...
for (my $i=0; $i < 10000; $i++){
	...
	my $probabilities = Math::Random::Discrete->new(
        \@likeld,
        \@alphabet,
	);
	print  $probabilities->rand;
					}
...
#Realizar el plot basado en las progabildiades de cada nucleotido en un cuadro 
#  .	.
#  
#
#  .	.
#frctalidad de la secuencia 
#hacerlo comparando seucencas de grupos no relacioandos 
###################################################################################################################
### Generar arboles  en 3D 4 tipos de arboles diferentes basados en  Lindenmayer, leopardos y cebras con movimietnos el priemro basado en repulsion y las cebras en manada atraidas por los arboles 
