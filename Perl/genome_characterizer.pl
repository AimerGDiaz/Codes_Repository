...
#@<<<<<<<@<<<<<<@<<<<<<@<<<<<<@<<<<<<<<@<<<<<<<<@<<<<<<<<@<<<<<<<<@<<<<<<<<<@<<<<<<<<<<<<<<<<<<<<<<<<<
#267     155     5               125     7184    1346562 2229012 32179566        208.7e6         Zea_mays.AGPv4.dna_rm.

		format Spaces =
@<<<<<<<<<<<<<<	@<<<<<	@<<<<<<	@<<<<<<<	@<<<<<<<<	@<<<<<<<<	@<<<<<<<<<	@<<<<<<<<<<<<<	@<<<<<<<<<<<<<<	@<<<<<<<<<<<<<<<<<<<<<	@<<<<<<<<<<<<
$ntotal, $n, $nn50, $min, $q2, $mean, $n50, $max, $sumeng, $path, $ncont
.
		format Pipes =
|@<<<<<<<|@<<<<<|@<<<<<|@<<<<<|@<<<<<<<|@<<<<<<<|@<<<<<<<|@<<<<<<<|@<<<<<<<<|@*|
...
format Spaces_TOP =
n       n:@<<< n:N50  min    median    mean     N50      max      sum    ncontent
$opt_threshold
.
format Pipes_TOP =
