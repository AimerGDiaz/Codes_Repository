...
library(ggpubr)
library(tidyverse)
#BiocManager::install(c("org.At.tair.db","enrichplot","GOSemSim","clusterProfiler"))
...
Base on a post in (datanovia)[https://www.datanovia.com/en/blog/how-to-create-a-beautiful-plots-in-r-with-summary-statistics-labels/]
```{r}
# Demo data
data("ToothGrowth")
df <- ToothGrowth
