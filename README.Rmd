...
One of my favorite codes made a classificatory tasks extremely fast and with just a handful set of commands, sadly it makes also the code pretty dark for the first times.  
...
<details> 
<summary>
The output of this script</summary>
...
PRINT here how it work to make quick table (Mirnomics project) or for database cleaning 
